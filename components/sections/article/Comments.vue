                ...
                <div class="d-flex align-start">
                    ...
                    <div class="comment-part">
                        <div class="d-flex align-center user-details">
                            ...
                            <span class="comment-time ml-3"> On {{
                                comment.time
                            }}</span>
                            <span
                                v-if="comment.commentor.badge"
                                style="line-height:1.5"
                                class="ml-4 font-weight-bold py-0 badge success-border"
                                >
                                {{ comment.commentor.badge }}
                            </span>
                        </div>
                        ...
                        <div class="comment-part">
                            <div class="d-flex align-center user-details">
                                ...
                                <v-menu v-if="$auth.loggedIn" offset-y left>
                                    ...
                                    <v-list>
                                        <v-list-item-group color="primary">
                                            <v-list-item @click="report('comment-reply', reply.id)">
                                                <v-list-item-title>Report an abuse</v-list-item-title>
                                            </v-list-item>
                                            <v-list-item 
                                                @click="deleteCommentR(reply.id,i,index)" 
